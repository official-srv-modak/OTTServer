                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="index.php"><img src="images/modakflix.png" alt="logo" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="banner-main">
            ...
            <div class="container">
                <div class="text-bg relative">
                    <h1>Welcome To The MODAKFLIX</h1>
                    <p>This is a website created by a Film and TV show enthusiast, who pirates the downloaded movies and wanted</br>that all the members of the house 
                    has access to the downloaded content. Go ahead login to the WIFI, download the APP and STREAM</p>
                </div>
